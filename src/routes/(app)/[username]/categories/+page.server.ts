...
export const load: PageServerLoad = (async ({ url, parent }) => {
	...
	const categories = await withCursor.execute()
	return { categories }
}) satisfies PageServerLoad

function setSort<T>(query: SelectQueryBuilder<DB, 'categories', T>, url: URL) {
...
} as const satisfies Record<Sortable, keyof Category>
